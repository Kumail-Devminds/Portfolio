...
const socialLinks = [
  {
    href: 'https://github.com/Kumail-Devminds',
        ...
        lg:items-stretch">
            ...
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                    Let’s connect and turn your ideas into reality—reach out today to explore how we can create something extraordinary together!
                </p>
            ...
            <form 
                action="https://formspree.io/f/mqadnzkp" 
                method="POST"
            ...
            >
                ...
                [&]:max-w-full w-full justify-center reveal-up">
                    Send Message
                </button>
            </form>
        </div>
